 ...
 */
public class EADAdapter extends ArrayAdapter<String> {
    public EADAdapter(Context context, ArrayList<String> users) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.ead_city_item, parent, false);
        }
